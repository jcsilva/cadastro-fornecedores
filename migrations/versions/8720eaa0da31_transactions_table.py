...
Revision ID: 8720eaa0da31
Revises: 
Create Date: 2018-04-20 15:49:08.793144
...
def upgrade():
    ...
    op.create_index(op.f('ix_provider_address'), 'provider', ['address'], unique=True)
    op.create_index(op.f('ix_provider_name'), 'provider', ['name'], unique=True)
    op.create_table('transaction',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('products', sa.String(length=512), nullable=True),
